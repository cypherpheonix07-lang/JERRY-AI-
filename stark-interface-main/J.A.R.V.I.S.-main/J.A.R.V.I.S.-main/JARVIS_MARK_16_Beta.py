...
style = ttk.Style()
style.theme_use('clam')  # Use a theme that supports styles
style.configure("RoundedEntry.TEntry", 
                fieldbackground="#2c2f3a", 
                foreground="white", 
                borderwidth=1, 
                relief="flat",
                padding=10)
...
avatar_label = tk.Label(app, bg="#1e1e2f")
...
# Talk Button
talk_button = ctk.CTkButton(root, text="🎙️ Talk to Jarvis", command=threaded_listen_and_respond,
...
user_entry = ctk.CTkEntry(input_frame, width=300, height=30, corner_radius=50,
                          font=("Consolas", 14), placeholder_text="Type your command...")#new
...
# Send Button
send_button = ctk.CTkButton(input_frame, text="Send", command=handle_user_input,corner_radius=50, font=("Arial", 12))
send_button.pack(side=tk.LEFT, padx=5 ,pady = 5)


# Startup Greeting
tts_engine.say("Initialising Jarvis.")
tts_engine.runAndWait()
